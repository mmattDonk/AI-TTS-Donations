...
from pedalboard import (Chorus, Compressor, Distortion, Gain, HighpassFilter,
                        Limiter, LowpassFilter, Pedalboard, PitchShift,
                        Resample, Reverb)
...
def reset_overlay() -> None:
    with open("./src/ai_tts_donations/overlay/index.html", "w") as html:
        html_code = f"""<head>
        {JS_STRING}
...
if not os.path.exists(path_exists("./src/ai_tts_donations/overlay/index.html")):
    reset_overlay()
...
if not os.path.exists("src/ai_tts_donations/voice_files"):
    os.makedirs("src/ai_tts_donations/voice_files")

    if not os.path.exists(path_exists("./src/ai_tts_donations/voice_files/README.md")):
        with open("./src/ai_tts_donations/voice_files/README.md", "w") as readme:
            readme.write(
...
if not os.path.exists("src/ai_tts_donations/playsounds"):
    os.makedirs("src/ai_tts_donations/playsounds")

    if not os.path.exists(path_exists("./src/ai_tts_donations/playsounds/README.md")):
        with open("./src/ai_tts_donations/playsounds/README.md", "w") as readme:
            readme.write(
...
playsounds.extend(file for file in os.listdir("src/ai_tts_donations/playsounds") if file.endswith(".wav"))
