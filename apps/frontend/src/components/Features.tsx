...
const features = [
	{
		icon: Coin,
		title: 'Free to use',
		description: 'All features in AI TTS Donations are completely free. No fees, and no subscriptions. Simply download, setup, and use. No payments required at all.',
	},
	{
		icon: Globe,
		title: 'Open Source',
