...
- playsounds:
  - remove `elif` chaining ([#115](https://github.com/mmattDonk/AI-TTS-Donations/pull/115)) 
...
* chore(deps): bump pyupgrade from 2.30.1 to 2.31.0 by @dependabot in https://github.com/mmattDonk/AI-TTS-Donations/pull/93
* chore(pre-commit): pre-commit autoupdate by @pre-commit-ci in https://github.com/mmattDonk/AI-TTS-Donations/pull/95
* chore(workflows): remove me as an assignee by @mmattbtw in https://github.com/mmattDonk/AI-TTS-Donations/pull/97
* chore(deps): bump rich from 10.16.2 to 11.0.0 by @dependabot in https://github.com/mmattDonk/AI-TTS-Donations/pull/98
* chore(deps): bump pre-commit from 2.16.0 to 2.17.0 by @dependabot in https://github.com/mmattDonk/AI-TTS-Donations/pull/99
* chore(deps): bump rich from 11.0.0 to 11.1.0 by @dependabot in https://github.com/mmattDonk/AI-TTS-Donations/pull/101
* chore(deps): bump black from 21.12b0 to 22.1.0 by @dependabot in https://github.com/mmattDonk/AI-TTS-Donations/pull/100
* chore(pre-commit): pre-commit autoupdate by @pre-commit-ci in https://github.com/mmattDonk/AI-TTS-Donations/pull/102
* feat(core): Added fallback voices by @mmattbtw in https://github.com/mmattDonk/AI-TTS-Donations/pull/103
* docs(CHANGELOG): update release notes by @github-actions in https://github.com/mmattDonk/AI-TTS-Donations/pull/104
